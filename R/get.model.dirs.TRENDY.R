get.model.dirs.TRENDY <- function(version = "v11"){
  ...
  if (version == "v11"){
    ...
    model.dirs <- c("Example")
  } else {
    model.dirs <- c("CLASSIC","CLM5.0","DLEM","IBIS","ISAM","ISBA-CTRIP",
