...
for (cyear in years){
  ...
  if ((cyear %% 10) == 0 | cyear == max(years)){
    ...
    saveRDS(df.all.monthly,
            paste0("./outputs/monthly.climate.global.",cyear,".RDS"))
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/monthly.climate.global.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
