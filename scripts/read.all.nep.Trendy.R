...
# model.names <- c("CLASSIC","CLM5.0","DLEM")
...
for (imodel in seq(1,length(model.dir))){
  ...
  for (iscenario in seq(1,length(scenarios))){
    ...
    for (ivariable in seq(1,length(variables))){
      ...
      saveRDS(cdf,
              paste0("./outputs/Trendy.",cmodel,".",cscenario,".",cvariable,"_YGB_v11.RDS"))
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/read.all.nep.Trendy.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
