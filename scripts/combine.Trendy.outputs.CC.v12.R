...
for (cmodel in model.names){
  ...
  for (cvariable in variables){
    ...
    for (cscenario in scenarios){
      ...
      op.file <- paste0("./outputs/Trendy.",cmodel,".",cscenario,".",cvariable,".global.v12.RDS")
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/combine.Trendy.outputs.CC.v12.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
