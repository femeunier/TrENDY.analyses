...
for (imodel in seq(1,length(model.dir))){
  ...
  for (iscenario in seq(1,length(scenarios))){
    ...
    for (ivariable in seq(1,length(variables))){
      ...
      #
      # saveRDS(cdf.rspld,
      #         paste0("./outputs/Trendy.",cmodel,".",cscenario,".",cvariable,"_centralAfrica_v11_rspld.RDS"))
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/read.all.gpp.Trendy.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
