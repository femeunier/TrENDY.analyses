...
for (cmodel in model.names){
  ...
  OPfile <- paste0("./outputs/Trendy.",cmodel,".S2.WC.pantropical.v11.RDS")
  ...
  if (all(unique(c("evapotrans") %in% df.model$variable))){
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/combine.Trendy.outputs.WC.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
