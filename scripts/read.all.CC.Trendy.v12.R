...
maindir <- "/data/gent/vo/000/gvo00074/felicien/TrENDYv12/"

model.names <- TrENDY.analyses::get.model.names.TRENDY(version = "v12")
...
# scp /home/femeunier/Documents/projects/TrENDY.analyses/scripts/read.all.CC.Trendy.v12.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
